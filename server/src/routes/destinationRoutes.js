...
const { checkDestinationOwnership, checkDestinationOwnershipOnly } = require('../middlewares/checkDestinationOwnership');
...
router.put('/destinations/:id/delete-image', validateMongoId, auth, checkDestinationOwnership, delete_image);
