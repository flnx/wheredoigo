...
const props = {
    images: [
        {
            imageUrl:
                'https://res.cloudinary.com/degidchop/image/upload/v1688464712/cld-sample-3.jpg',
            _id: 'id1',
        },
        {
            imageUrl:
                'https://res.cloudinary.com/degidchop/image/upload/v1688464712/cld-sample-4.jpg',
            _id: 'id2',
        },
        {
            imageUrl:
        ...
        {
            imageUrl:
                'https://res.cloudinary.com/degidchop/image/upload/v1688464712/cld-sample.jpg',
            _id: 'id4',
        },
        {
            imageUrl:
                'https://res.cloudinary.com/degidchop/image/upload/v1688464712/cld-sample-5.jpg',
            _id: 'id5',
        },
    ],
...
describe('Gallery correctly renders the images and sets the main image', () => {
    beforeEach(() => {
        // scrollIntoView doesnt exist outside the browser..
    ...
    it('Correctly renders the secondary cloudinary images (transformed)', () => {
        const images = screen.getAllByAltText(new RegExp(props.alt, 'i'));
        ...
        images.slice(1).forEach((image, i) => {
            ...
            const transformedImage = applyCloudinaryTransformation(validImageUrl);

            expect(image).toHaveAttribute('src', transformedImage);
        });
    });

    it.only('When clicked on a secondary image, it sets it as a MAIN Image', async () => {
        let mainImage;
        let expectedImgUrl;
        ...
        expect(imageToSetAsMain).toHaveAttribute(
            'src',
            applyCloudinaryTransformation(expectedImgUrl) // expects resized image
        );
        ...
        expect(anotherImageToSetAsMain).toHaveAttribute(
            'src',
            applyCloudinaryTransformation(expectedImgUrl)
        );
